...
The previous generated banner was replaced rather than retained. The README also contains two desktop captures from the real release example:

- `assets/readme/previews/showcase.png`: 1440 x 900 desktop showcase.
- `assets/readme/previews/layers.png`: 1440 x 900 Data Layers view with the graticule and route layers visible.
